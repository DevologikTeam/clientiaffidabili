...
import { getCheckoutCtaLabel } from '@/lib/runtime/commerce-mode';
          ...
          <div className="container ca-detail-grid">
            <div className="ca-stack">
              ...
              <div className="hero-actions">
                <Button href={`/checkout?service=${service.code}`} size="lg">{getCheckoutCtaLabel(service.status === 'assisted' ? 'Richiedi verifica assistita' : 'Avvia verifica')}</Button>
                <Button href="/servizi" variant="outline" size="lg">Torna al catalogo</Button>
              </div>
              <TestModeNotice context="compact" />
            </div>
