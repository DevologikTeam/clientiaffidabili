...
- v0.74.16: Docker Builder pnpm CLI Symlink Patch 14.
- v0.74.14: Coolify Preflight Dependency Bootstrap Patch 13.
- v0.74.12: Docker Optional Shared Node Modules Patch 11.
- v0.74.10: Docker Runtime Next Root Resolution Patch 10.
- v0.74.1: Web Build Static Guards Patch.
- v0.74.2: Web Build Static Guards Patch 2.
- v0.74.3: Web Build Static Guards Patch 3.
- v0.74.4: Web Build Static Guards Patch 4.
- v0.74.5: Web Build Static Guards Patch 5.
- v0.74.6: Web Build Static Guards Patch 6.
